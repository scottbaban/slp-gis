...
import tagoloanprojects from './tagoloan'; // Assuming cdo.js is in the same directory
import './TagoloanPhProjects.css'; // Import the CSS file for styling

function TagoloanPhProjects() {
  return (
    <div>
      <h1>SD Projects in Tagoloan (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {tagoloanprojects.map((project, index) => (
            <tr key={index}>
...
export default TagoloanPhProjects;
