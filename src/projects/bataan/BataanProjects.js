...
import bataanprojects from './bataan'; // Assuming cdo.js is in the same directory
import './BataanPhProjects.css'; // Import the CSS file for styling

function BataanPhProjects() {
  return (
    <div>
      <h1>SD Projects in Bataan (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {bataanprojects.map((project, index) => (
            <tr key={index}>
...
export default BataanPhProjects;
