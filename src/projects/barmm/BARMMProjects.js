...
import barmmprojects from './barmm'; // Assuming cdo.js is in the same directory
import './BARMMPhProjects.css'; // Import the CSS file for styling

function BARMMPhProjects() {
  return (
    <div>
      <h1>SD Projects in BARMM (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {barmmprojects.map((project, index) => (
            <tr key={index}>
...
export default BARMMPhProjects;
