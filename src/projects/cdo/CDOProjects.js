...
import cdoprojects from './cdo'; // Assuming cdo.js is in the same directory
import './CDOPhProjects.css'; // Import the CSS file for styling

function CDOPhProjects() {
  return (
    <div>
      <h1>SD Projects in CDO (2017-2021)</h1>
