...
import balingasagprojects from './balingasag'; // Assuming cdo.js is in the same directory
import './BalingasagPhProjects.css'; // Import the CSS file for styling

function BalingasagPhProjects() {
  return (
    <div>
      <h1>SD Projects in Balingasag (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {balingasagprojects.map((project, index) => (
            <tr key={index}>
...
export default BalingasagPhProjects;
