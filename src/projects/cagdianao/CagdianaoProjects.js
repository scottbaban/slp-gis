...
import cagdianaoprojects from '../cagdianao/cagdianao'; // Assuming cdo.js is in the same directory
import './CagdianaoPhProjects.css'; // Import the CSS file for styling

function CagdianaoPhProjects() {
  return (
    <div>
      <h1>SD Projects in Cagdianao (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {cagdianaoprojects.map((project, index) => (
            <tr key={index}>
...
export default CagdianaoPhProjects;
