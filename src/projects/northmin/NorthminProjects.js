...
import northminprojects from './northmin'; // Assuming cdo.js is in the same directory
import './NorthminPhProjects.css'; // Import the CSS file for styling

function NorthminPhProjects() {
  return (
    <div>
      <h1>SD Projects in Region X (2017-2021)</h1>
      ...
      <table>
        ...
        <tbody>
          {northminprojects.map((project, index) => (
            <tr key={index}>
...
export default NorthminPhProjects;
