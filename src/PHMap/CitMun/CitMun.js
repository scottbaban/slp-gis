...
function CitMun() {
  const geoJSONLayers = [
    { data: balingasagData, name: "SD Projects in Balingasag (2017-2021)" },
    { data: cdoData, name: "SD Projects in CDO (2017-2021)" },
    { data: marawiData, name: "SD Projects in Marawi (2017-2021)" },
    { data: ncrData, name: "SD Projects in NCR (2017-2021)" },
    { data: bataanData, name: "SD Projects in Bataan (2017-2021)" },
    { data: cagdianaoData, name: "SD Projects in Cagdianao (2017-2021)" },
    { data: tagoloanData, name: "SD Projects in Tagoloan (2017-2021)" },
  ];
      ...
      <PHMap>
        {geoJSONLayers.map((layer, index) => (
          <GeoJSON
            ...
            data={layer.data}
            style={(feature) =>
              feature === hoveredFeature ? mapTileHoverStyle : mapTileStyle
            }
